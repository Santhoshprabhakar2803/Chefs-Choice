...
public class APP_11FASTFOOD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_11_fastfood);
        // quantity
    ...
    private void gotocart1() {
        Intent intent = new Intent(APP_11FASTFOOD.this, APP_7.class);
